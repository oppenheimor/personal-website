...
素材包本身要有用。一个人打开它，应该能快速知道这件事有哪些事实、案例、截图和可引用的观点。

灵感池本身要有用。即便今天不发，里面也应该沉淀出一些值得以后继续做的选题。

选题评分要有用。它不能只给一个分数，而要说清楚为什么做、为什么不做、差在哪里。
...
我现在更愿意承认一件事：爆款不是按钮生成的。

能做的，是搭一套更好的实验系统。它帮助人更快看见素材，更快形成判断，更快试错，也更快知道自己错在哪里。
